      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <div className="space-y-6 text-on-surface-variant leading-relaxed">
            <p>{t('En OI Office Installations, creemos que el entorno de trabajo define el éxito de un equipo. Desde 2018, nos hemos dedicado a transformar espacios vacíos en oficinas dinámicas, funcionales y listas para inspirar.', 'At OI Office Installations, we believe the work environment defines a team\'s success. Since 2018, we have been dedicated to transforming empty spaces into dynamic, functional offices ready to inspire.')}</p>
