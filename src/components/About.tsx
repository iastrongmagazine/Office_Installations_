      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <div className="space-y-6 text-on-surface-variant leading-relaxed">
            <p>{t('Con más de 15 años de experiencia en la industria y 8 años en servicio, nos enorgullecemos de ofrecer resultados eficientes, profesionales y orientados al detalle.', 'With over 15 years of industry experience and 8 years in service, we take pride in delivering efficient, professional, and detail-driven results.')}</p>
            <p>{t('Manejamos cada proyecto con cuidado, asegurando que su mobiliario de oficina esté protegido e instalado con los más altos estándares, ya sea para pequeñas empresas o entornos corporativos a gran escala.', 'We handle every project with care, ensuring your office furniture is protected and installed to the highest standards—whether for small businesses or large-scale corporate environments.')}</p>
            <p>{t('Además de los servicios de reubicación, brindamos servicios completos de instalación y reconfiguración de todos los sistemas de mobiliario de oficina, incluidos cubículos, estaciones de trabajo y configuraciones completas de oficina.', 'In addition to relocation services, we provide full-service installation and reconfiguration of all office furniture systems, including cubicles, workstations, and complete office setups.')}</p>
          </div>
          <div className="pt-6">
