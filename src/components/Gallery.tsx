      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-on-surface-variant max-w-2xl mx-auto">
            {t('Explora algunos de nuestros proyectos recientes. Cada espacio es una muestra de nuestra precisión, cuidado y compromiso con la excelencia en la instalación de mobiliario corporativo.', 'Explore some of our recent projects. Each space is a showcase of our precision, care, and commitment to excellence in corporate furniture installation.')}
          </p>
        </div>
